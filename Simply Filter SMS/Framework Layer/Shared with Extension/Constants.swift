...
let kAutomaticFiltersInactivityNotificationId = "automatic-filters-inactivity-reminder"
let kAutomaticFiltersNotificationExplainerMaxAsks = 3
let kAutomaticFiltersNotificationExplainerMinSessionsBetweenAsks = 3
